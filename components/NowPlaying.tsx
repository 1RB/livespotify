...
export default function NowPlaying() {
  ...
  useEffect(() => {
    const checkProgress = () => {
        const current = Math.round((data?.currentTimestamp / data?.totalLength) * 1000000000);
        setProgress(current);
        console.log(current)
    };
  ...
  return (
    <div className="flex flex-col items-center space-y-1 w-full sm:w-auto">
      <div className="text-s font-bold text-gray-600 dark:text-gray-400">
      ...
      <div className="flex flex-col justify-center items-center my-4">
        ...
        {data?.songUrl ? (
          <a
            className="block font-bold text-xxl sm:text-2xl text-gray-900 dark:text-gray-100 hover:text-gray-800"
            href={data.songUrl}
            target="_blank"
          ...
          <div className="font-bold text-xxl sm:text-2xl text-gray-900 dark:text-gray-100">
            Nothing Playing
          </div>
        )}
        <div className="text-s font-bold text-gray-600 dark:text-gray-400">
